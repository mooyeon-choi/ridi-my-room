...
const ITEMS = [
  ...
  { id: 'stone_mask',          name: '석가면',           description: '달빛을 받으면 무언가 일어난다는 전설의 가면. 인간을 초월한 존재가 될 수 있다.', img: '/assets/items/stone_mask.png' },
  { id: 'grappling_hook',      name: '입체기동장치',      description: '거인에 맞서 싸우기 위한 인류의 희망. 자유를 향해 날아오른다.', img: '/assets/items/grappling_hook.png' },
  ...
  { id: 'pokedex',             name: '포켓몬 도감',       description: '세계의 모든 포켓몬 정보가 담긴 전자 도감. 포켓몬 마스터를 향한 첫걸음.', img: '/assets/items/pokedex.png' },
