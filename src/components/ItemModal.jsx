...
const ITEMS = [
  ...
  { id: 'cat_black',           name: '로이',                 description: '작품을 감상하고 돌아오면 어느새 나타나 있는 까만 고양이. 감성이 풍부해 눈물을 잘 흘린다.', img: '/assets/pets/cat_black.png' },
  { id: 'cat_gray',            name: '론',                   description: '작가를 응원하는 마음에 감동받아 따라온 회색 고양이. 결제 알림 소리에 꼬리를 흔든다.', img: '/assets/pets/cat_gray.png' },
