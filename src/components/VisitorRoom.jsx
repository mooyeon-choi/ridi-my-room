...
const styles = {
  ...
  exitBtn: {
    padding: '10px 20px', background: '#5c3322',
  ...
  sideButtons: { display: 'flex', flexDirection: 'column', gap: '10px', alignSelf: 'flex-start' },
  sideBtn: {
    background: '#3a1010', border: '1px solid #6b2a2a',
  ...
  dialogueBox: {
    ...
    borderRadius: '9999px', minHeight: '60px',
    display: 'flex', alignItems: 'center',
    boxShadow: '0 2px 6px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.3)',
    border: '3px solid #753F22',
  },
  dialogueText: { color: '#3d2210', fontSize: '18px', lineHeight: '1.5', fontWeight: '500', flex: 1 },
  chatArea: {
  ...
  visitTitle: { color: '#f5e6c8', fontSize: '16px', fontWeight: 'bold', textAlign: 'center' },
  visitRoomList: { display: 'flex', flexDirection: 'column', gap: '6px' },
  visitRoomBtn: {
  ...
  visitRoomTheme: {
    background: '#5c3018', color: '#f0c060', fontSize: '11px',
    fontWeight: 'bold', padding: '2px 8px', borderRadius: '4px', flexShrink: 0,
  },
  visitRoomLabel: { color: '#f5e6c8', fontSize: '14px' },
  visitDivider: { borderTop: '1px solid #5c3018', margin: '4px 0' },
  visitInput: {
    background: '#e8d09a', border: '2px solid #5c3018',
    borderRadius: '6px', padding: '10px 14px',
    fontSize: '14px', color: '#3d2210', outline: 'none',
  },
  visitBtns: { display: 'flex', gap: '8px', justifyContent: 'flex-end' },
  visitCancelBtn: {
    background: '#7a4e28', border: '2px solid #5c3018', borderRadius: '4px',
    color: '#f5e6c8', fontSize: '13px', fontWeight: 'bold', padding: '8px 16px', cursor: 'pointer',
  },
  visitConfirmBtn: {
